      ...
      <div class="tab-pane fade active in" id="home">
         <div class="panel panel-default f_paneldefualt">
            ...
            <div id="question0" class="panel-collapse collapse" style="height: 0px;">
               <div class="panel-body f_privacy_panel">
                  <p class="f_take">We take our responsibilities regarding the protection of personal information very seriously. This policy explains how we use personal information that we may obtain from you. By using our website www.tajawal.com (henceforth referred to as tajawal) which also <br>comprises of the mobile site, smartphone app platforms such as iOS, Android, Windows (all together referred to as “site”), you consent<br> to this use. This privacy policy does not apply to the websites of our business partners, corporate affiliates or to any other third parties,<br> even if their websites are linked to the site. We recommend you review the respective privacy statements of the other parties with<br> whom you interact.</p>
                  <br>
                  <p class="f_take">When you use services provided on this website and/or mobile application, you will be asked to provide certain information such as<br> your name, contact details, and/or your debit/credit card details. We will store this information and hold it on computers or otherwise.</p>
               </div>
            </div>
         </div>
         <div class="panel panel-default f_paneldefualt">
