...
<section class="triprite">
   ...
   <div class="container-fluid f_padding">
      <div class="w3-content w3-display-container">
         <img class="mySlides" src="{{asset('public/assets/images/banner.jpg')}}" class="img-responsive" style="width:100%">
         <img class="mySlides" src="{{asset('public/assets/images/banner1.jpg')}}" class="img-responsive" style="width:100%">
         <img class="mySlides" src="{{asset('public/assets/images/banner2.jpg')}}" class="img-responsive" style="width:100%">
                        ...
                        <div class="row">
                           <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                              <div class="frontend-box">
                                 <div class="frontend-box-inner">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/image_one.jpg')}}">                                         
                                    </div>
                           ...
                           <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                              <div class="frontend-box">
                                 <div class="frontend-box-inner">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/image_two.jpg')}}">                                         
                                    </div>
                                    <div class="course-detail-front">
                                       <h5>Luxury with ultra superior room</h5>
                                       <div class="row margin-custom">
                           ...
                           <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                              <div class="frontend-box">
                                 <div class="frontend-box-inner">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/image_three.jpg')}}">                                         
                                    </div>
                                    <div class="course-detail-front">
                                       <h5>Luxury with ultra superior room</h5>
                                       <div class="row margin-custom">
                        ...
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3">
                              <div class="frontend-box">
                                 <div class="frontend-box-last">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/popular_image1.jpg')}}" class="img-responsive">
                                    </div>
                                    <div class="row margin-custom">
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3">
                              <div class="frontend-box">
                                 <div class="frontend-box-last">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/popular_image2.jpg')}}" class="img-responsive">
                                    </div>
                                    <div class="row margin-custom">
                                       <div class="col-md-8 text-left">
                                          <h5 class="course-detail-front">Atlantis - The Palm</h5>
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3">
                              <div class="frontend-box">
                                 <div class="frontend-box-last">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/popular_image3.jpg')}}" class="img-responsive">
                                    </div>
                                    <div class="row margin-custom">
                                       <div class="col-md-8 text-left">
                                          <h5 class="course-detail-front">Atlantis - The Palm</h5>
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3">
                              <div class="frontend-box">
                                 <div class="frontend-box-last">
                                    <div class="img">
                                       <img src="{{asset('public/assets/images/popular_image4.jpg')}}" class="img-responsive">
                                    </div>
                                    <div class="row margin-custom">
                                       <div class="col-md-8 text-left">
                                          <h5 class="course-detail-front">Atlantis - The Palm</h5>
