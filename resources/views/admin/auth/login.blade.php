...
<html>
   ...
   <body class="hold-transition login-page">
      ...
      <!-- /.login-box -->
      <!-- jQuery -->
      <script src="{{asset('public/admin/admin_assets/plugins/jquery/jquery.min.js')}}"></script>
      <!-- Bootstrap 4 -->
      <script src="{{asset('public/admin/admin_assets/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
      <!-- iCheck -->
      <script src="{{asset('public/admin/admin_assets/plugins/iCheck/icheck.min.js')}}"></script>
      <script>
         $(function () {
           $('input').iCheck({
